...
const offices = [
  ...
  { id: 3, city: 'Hawaii', address: ['7363 Cynthia Pass', 'Sunset Beach, Oahu, HI'] },
  { id: 4, city: 'Singapore', address: ['111 River Valley Road', 'Singapore, Singapore'] },
];
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
          ...
          <div className="mt-12 border-t border-warm-gray-700 pt-8">
            <p className="text-base text-warm-gray-400 xl:text-center">
              &copy; {new Date().getFullYear()} Kinzulting LLC. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
